    ...
    <div className='min-h-screen  flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      <form
        ...
        <div className='flex flex-col gap-2'>
          {state === "Sign up" ? (
            <p
              onClick={() => { setState("Login"); setIsDataSubmitted(false) }}
              className='text-sm text-gray-600 '>Already have an account? <span className='font-medium text-violet-500 cursor-pointer '>Sign In</span></p>
          ) : (
            <p
